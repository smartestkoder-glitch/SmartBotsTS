...
const ahUtils = {
    ...
    getBoughtCountItem: (bot :Bot, newVersion :boolean = false) => {
        ...
        if (newVersion) maxSlots = detectDonate.slots.newVersion[donate]
        else maxSlots = detectDonate.slots.oldVersion[donate]
